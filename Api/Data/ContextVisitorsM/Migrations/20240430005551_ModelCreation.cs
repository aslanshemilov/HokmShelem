...
namespace Api.Data.ContextVisitorsM.Migrations
{
    /// <inheritdoc />
    public partial class ModelCreation : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VisitorMessage", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VisitorMessage_Visitor_VisitorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VisitorMessage_VisitorId",
